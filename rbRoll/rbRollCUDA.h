...
//C++ CUDA Multithreaded Deformer implementation of rbRoll python deformer plugin blockout
...
try:
	...
	rbRollNode = pm.deformer(type = 'rbRollCPPCUDA')[0]
...
//RbRollCUDA class declaration
//-----------------------------------------------
class RbRollCUDA : public MPxDeformerNode
{
public:
	...
	int executeAddTwoIntegers(int a, int b);
	...
	static MObject aComputeParallel;
